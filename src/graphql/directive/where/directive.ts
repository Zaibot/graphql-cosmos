import { DirectiveLocation, GraphQLDirective, GraphQLSchema, GraphQLString, getDirectiveValues, DirectiveNode } from 'graphql';
import { SchemaDirectiveVisitor } from 'graphql-tools';
import { isSqlOperation } from '../../../sql/op';

export class WhereDirective extends SchemaDirectiveVisitor<{ op?: string; ours?: string }> {
    ...
    static getOp(directiveName: string, schema: GraphQLSchema, node: { readonly directives?: readonly DirectiveNode[] | undefined }) {
