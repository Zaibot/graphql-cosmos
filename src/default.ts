...
import { CosmosQueryHandler, DataLoaderSpec, GraphQLCosmosDataLoaderResolver, GraphQLCosmosInitRequest, GraphQLCosmosRequest } from './configuration';
...
export const defaultDataLoader = (onQuery: CosmosQueryHandler): GraphQLCosmosDataLoaderResolver => ({ container }: { container: string }) => {
